...
public class PendingRequestArgs extends ItemInfo implements Parcelable {
    ...
    public PendingRequestArgs(Parcel parcel) {
        ...
        ///M: ALPS03446909: Used classloader as a argument instead of null for
        ///  avoiding delay in loading class.
        if (mObjectType == TYPE_INTENT) {
            mObject = parcel.readParcelable(Intent.class.getClassLoader());
        }else if(mObjectType == TYPE_APP_WIDGET){
            mObject = parcel.readParcelable(WidgetAddFlowHandler.class.getClassLoader());
        }else {
